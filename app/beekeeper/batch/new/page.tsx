...
export default function NewBatchPage() {
  ...
  const generatedId = `HC-MP-2026-${String(Math.floor(Math.random() * 900) + 100)}`;
      ...
      {created ? (
        <div className="bg-white border border-black/5 rounded-2xl p-8 text-center">
          ...
          <div className="text-muted text-sm mb-6">
            <span className="font-mono">{generatedId}</span> is linked to {hiveId} and ready for quality
            verification.
          </div>
          <Link
